        # Metaguard: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metaguard.git

        ## Objective

        MetaGuard is a frontier meta-analysis toolkit combining DPD robust estimation, real-time meta-analysis (RTMA) p-hacking detection, and MetaForest machine-learning heterogeneity modelling.
        ...
        - Code: https://github.com/mahmood726-cyber/metaguard.git
